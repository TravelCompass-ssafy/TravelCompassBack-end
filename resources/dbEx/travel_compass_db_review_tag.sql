...
CREATE TABLE `review_tag` (
  ...
  KEY `trip_review_trip_review_id_idx` (`trip_review_id`),
  CONSTRAINT `trip_review_trip_review_id` FOREIGN KEY (`trip_review_id`) REFERENCES `trip_review` (`trip_review_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2024-05-17  8:24:51
