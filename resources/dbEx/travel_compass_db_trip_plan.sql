...
CREATE TABLE `trip_plan` (
  ...
  UNIQUE KEY `trip_plan_id_UNIQUE` (`trip_plan_id`),
  KEY `trip_plan_trip_detail_id_trip_detail_trip_detail_id_idx` (`trip_detail_id`),
  CONSTRAINT `trip_plan_trip_detail_id_trip_detail_trip_detail_id` FOREIGN KEY (`trip_detail_id`) REFERENCES `trip_detail` (`trip_detail_id`) ON DELETE CASCADE ON UPDATE CASCADE
